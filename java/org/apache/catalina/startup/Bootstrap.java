...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        // 通过反射实例化org.apache.catalina.startup.Catalina类的实例
        ...
        // 反射调用Catalina实例的setParentClassLoader方法设置parentClassLoader为sharedLoader
        ...
        // 将Catalina实例赋值给Bootstrap实例的catalinaDaemon属性
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                /**
                 * 调用load() + start() 来加载配置和启动容器
                 * daemon就是Catalina实例
                 */
                // 为了让tomcat在关闭端口阻塞监听关闭命令，参考Catalina.await()
